...
from src.utils.algorithm import TMKFramework, EpisodeResult, TIER_ORDER
...
def main():
    ...
    parser.add_argument(
        "--events",
        default="src/contents/tmk_events_release_1.2.xls",
    )
    parser.add_argument(
        "--annual",
        default="src/contents/tmk_annual_release_1.2.xlsx",
    )
